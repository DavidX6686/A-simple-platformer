#CN is the filler block that is pure green
#
import json
import pygame
import sys
...
hero_images = {"run": [hero_walk1, hero_walk2],
               "jump": hero_jump,
               "idle": hero_idle}
#In order to add new tiles just right click tiles in assets and add in a picture of the tile and and add as shown here:
block_images = {"TL": load_image("assets/tiles/top_left.png"),
                ...
                "ST": load_image("assets/tiles/stone_wall.png")}
...
class Game():
    ...
    def display_stats(self, surface):
        ...
        score_text = FONT_SM.render("Coins: " + str(self.hero.score), 1, WHITE)
    ...
    def draw(self):
        ...
        if self.stage == Game.SPLASH:
            ...
            self.display_message(self.window, "Woo Hoo, You Win!", "Press 'R' to restart.")
        elif self.stage == Game.GAME_OVER:
            self.display_message(self.window, "Game Over, Better Luck Next Time", "Press 'R' to restart.")
